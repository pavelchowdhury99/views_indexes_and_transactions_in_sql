...
select * from tutorial.demo_table_1 dt ;
...
select * from tutorials.demo_view_1;
...
select * from tutorials.demo_view_2;
...
(
	...
	price_per_item
--	col_5 as has_paid_bool
	from tutorials.demo_view_2
)
;


select * from tutorials.demo_view_3;



--- Caveat 2
alter table tutorials.demo_view_2
rename column review to reviews ;


--- Caveat 3
drop view tutorials.demo_view_2;
